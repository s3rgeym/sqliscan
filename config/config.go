...
func registerFlags(cfg *Config) {
	...
	flag.IntVar(&cfg.MaxCheckParams, "check-params", 10, "Maximum number of parameters to check for SQL injection vulnerabilities. Set to -1 to check all parameters.")
